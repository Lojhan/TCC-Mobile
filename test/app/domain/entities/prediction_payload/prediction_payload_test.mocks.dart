...
// in mobile/test/app/domain/entities/prediction_payload/prediction_payload_test.dart.
...
import 'package:cross_file/src/types/interface.dart' as _i3;
...
class MockFile extends _i1.Mock implements _i2.File {
  ...
  _i2.Directory get parent => (super.noSuchMethod(Invocation.getter(#parent),
      ...
      as _i2.Directory);
  @override
  _i4.Future<_i2.File> create({bool? recursive = false}) => (super.noSuchMethod(
          Invocation.method(#create, [], {#recursive: recursive}),
          returnValue: _i4.Future<_i2.File>.value(_FakeFile_1(
  ...
  DateTime lastAccessedSync() => (super.noSuchMethod(
          ...
          returnValue:
              _FakeDateTime_0(this, Invocation.method(#lastAccessedSync, [])))
      as DateTime);
  @override
  ...
  DateTime lastModifiedSync() => (super.noSuchMethod(
          ...
          returnValue:
              _FakeDateTime_0(this, Invocation.method(#lastModifiedSync, [])))
      as DateTime);
  @override
  ...
  _i2.IOSink openWrite(
      ...
      (super.noSuchMethod(
          ...
          returnValue: _FakeIOSink_5(
              this,
              Invocation.method(
                  #openWrite, [], {#mode: mode, #encoding: encoding}))) as _i2
          .IOSink);
  @override
  _i4.Future<_i6.Uint8List> readAsBytes() =>
      (super.noSuchMethod(Invocation.method(#readAsBytes, []),
  ...
  _i4.Future<_i2.File> writeAsBytes(List<int>? bytes,
      ...
      (super.noSuchMethod(
              ...
              returnValue: _i4.Future<_i2.File>.value(_FakeFile_1(this,
  ...
  _i2.FileStat statSync() => (super.noSuchMethod(
          ...
          returnValue: _FakeFileStat_6(this, Invocation.method(#statSync, [])))
      as _i2.FileStat);
  @override
  _i4.Future<_i2.FileSystemEntity> delete({bool? recursive = false}) => (super
          .noSuchMethod(Invocation.method(#delete, [], {#recursive: recursive}),
              returnValue: _i4.Future<_i2.FileSystemEntity>.value(
                  _FakeFileSystemEntity_7(this,
